...
void quick_sort(struct block my_data) {
    ...
    if(left_side.size > PARTITION || right_side.size > PARTITION ) {
...
int main(int argc, char *argv[]) {
    ...
    start_block.data = (int *)mmap(NULL, size * sizeof(int), PROT_READ | PROT_WRITE, MAP_SHARED | MAP_ANONYMOUS, -1, 0);
